...
This ais-simulator is developed in context of the DMA <<../README.adoc#AIS Simulator,near-miss>> project.
...
== Back
Back to <<../README.adoc#AIS Simulator,near-miss>> parent modul