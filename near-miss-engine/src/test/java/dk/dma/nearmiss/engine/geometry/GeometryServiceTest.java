...
public class GeometryServiceTest {
    ...
    public void test() {
        ...
        assertEquals(new EllipticSafetyZone(10, 55, 9.000009000009E-4, 3.922755290147471E-4, 15), safetyZone);

        safetyZone = sut.createEllipticSafetyZone(15, 175, 100, 25, 15);
        assertEquals(new EllipticSafetyZone(175, 15, 9.000009000009E-4, 2.3293714059226866E-4, 15), safetyZone);
    }

    @Test
    public void metersPerDegreeLatitude() {
        assertEquals(111111f, sut.metersPerDegreeLatitude(), 1e-6);
    }
