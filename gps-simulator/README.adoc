...
Refer to the link:src/main/java/dk/dma//nearmiss/gpssimulator/GpsSimulatorConfigurations.java[GpsSimulatorConfigurations.java] class.

Also refer to the configurtion files:

* link:src/main/java/resources/application.properties[application.properties]
* link:src/main/java/resources/application-dev.properties[application-dev.properties]
* link:src/main/java/resources/application-docker.properties[application-docker.properties]
